...
class _FiltroSelectorState extends ConsumerState<FiltroSelector> {
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  if (filtroState.brand != null &&
                          filtroState.brand!.isNotEmpty ||
                      filtroState.orderBy != 'date')
                    Container(
  ...
  Widget _buildSortTile(String label, String value, IconData icon) {
    ...
    return InkWell(
      onTap: () =>
          ref.read(productFilterProvider.notifier).update(orderBy: value),
      child: Container(
  ...
  Widget _buildNodo(CategoryModel cat, int nivel) {
    ...
    return Column(
      children: [
                ...
                Expanded(
                  child: Text(
                    ...
                    style: TextStyle(
                      ...
                      color: expandida ? AppColors.primary : Colors.black87,
                    ),
                  ),
                ),
                if (cat.count > 0)
        ...
        if (expandida && tieneHijos)
          ...hijos.map((h) => _buildNodo(h, nivel + 1)),
      ],
    );
  }
}
