...
class MundicamSearchEngine {
  ...
  static const List<String> knownBrands = [
    // Las marcas compuestas/específicas van primero para impedir que una marca
    // corta absorba a otra (MCI/MCI PRO, HIKVISION/HiWatch, etc.).
    'MCI PRO',
    'HIKVISION Hiwatch',
    'Johnson Controls',
    'EVOLVE Xtender',
    ...
    'ZKTECO',
    'ZTE',
    // Alias de entrada. No crean marcas adicionales en la UI.
    'hiwatch',
    'tplink',
    'unv',
    'security360',
