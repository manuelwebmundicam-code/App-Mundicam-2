...
class _AcademyEventImage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    // La imagen de Academy se obtiene directamente desde la página pública
    // del propio evento. No depende del campo image enviado por la API/PHP.
    ...
    return _AcademyPageImageFallback(courseUrl: courseUrl);
  }
}
