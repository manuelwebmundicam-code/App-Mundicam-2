            ...
            child: Column(
              ...
              children: [
                ...
                _buildSecurityBullet(
                  ...
                  'El pago se realiza en la pasarela segura de WooCommerce/Redsys.',
                ),
                _buildSecurityBullet(
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              'Estamos esperando la confirmación de Redsys/WooCommerce. Si ya has pagado, pulsa “Comprobar pago”.',
              style: TextStyle(
